...
import es.lda.core.lib.stv.STV;
...
public class ventana extends javax.swing.JFrame {
    ...
    public ventana() {
        ...
        //getContentPane().setBackground(Color.decode("#8FBC8B"));
        lblLink.setBackground(Color.decode("#8FBC8B"));
        jPanel11.setBorder(new TitledBorder(new LineBorder(Color.cyan,3),"Modelo STV"));
        jPanel12.setBorder(new TitledBorder(new LineBorder(Color.cyan,3),"Acciones"));
        jPanel13.setBorder(new TitledBorder(new LineBorder(Color.red,3),"Errores"));
        jPanel14.setBorder(new TitledBorder(new LineBorder(Color.yellow,3),"Fuente de Alimentacion"));
        jPanel15.setBorder(new TitledBorder(new LineBorder(Color.red,3),"Log"));
        jPanel16.setBorder(new TitledBorder(new LineBorder(Color.red,3),"Limiter Ch"));
        jPanel17.setBorder(new TitledBorder(new LineBorder(Color.yellow,2),"Infor"));
        this.pack();
    ...
    private void initComponents() {
        ...
        btBorraIncidencias.setText("Borrar Incidencias");
        ...
        btBorrarLogo.setText("Borrar Logo");
        ...
        chkConfiguracionEntradaDigital.setText("Entrada Digital");
        ...
        ckEnableEtherNet.setText("Habilitar EtherNet");
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel12Layout.createSequentialGroup()
                        .addGap(2, 2, 2)
                        .addComponent(btnReset, javax.swing.GroupLayout.PREFERRED_SIZE, 18, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel12Layout.setVerticalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel12Layout.createSequentialGroup()
                        .addGap(4, 4, 4)
                        .addComponent(btnReset, javax.swing.GroupLayout.DEFAULT_SIZE, 10, Short.MAX_VALUE))
                    .addGroup(jPanel12Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel3)))
                .addContainerGap())
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jPanel12, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
                    .addComponent(jPanel11, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE))
                .addGap(162, 162, 162))
        );
        ...
        chkErrRAM.setText("RAM");
        chkErrRAM.setOpaque(false);

        chkErrCobraNet.setText("CobraNet");
        chkErrCobraNet.setOpaque(false);

        chkErr3008.setText("Sensado Alimentacion");
        chkErr3008.setOpaque(false);

        chkErrTempETX.setText("Sensado Temp ETX");
        ...
        chkErrMod1.setText("Control Canal 1 y 2");
        chkErrMod1.setOpaque(false);

        chkErrMod2.setText("Control Canal 3 y 4");
        chkErrMod2.setOpaque(false);

        ChkErrFrontal.setText("Control Frontal");
        ChkErrFrontal.setOpaque(false);

        chkErrSobreTempETX.setText("SobreTemperatura ETX");
        ...
        chkPresetsPrio.setText("Prio");
        chkPresetsPrio.setOpaque(false);

        btnCargaDefault.setText("Cargar Default");
        ...
        btnGuardarDefault.setText("Guardar Default");
        ...
        btnCargarFabrica.setText("Cargar Fabrica");
        ...
        jLabel6.setText("Gain Linear Input Ch");
        ...
        jLabel10.setText("Gain Output Ch");
                            ...
                            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel5Layout.createSequentialGroup()
                                        ...
                                        .addGap(25, 25, 25)
                                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(nudEqInputQ_Slope1, javax.swing.GroupLayout.DEFAULT_SIZE, 64, Short.MAX_VALUE)
                                            .addComponent(nudEqInputFreq1, javax.swing.GroupLayout.DEFAULT_SIZE, 64, Short.MAX_VALUE)
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(tkbEqInputGain1, javax.swing.GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE)
                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
            ...
            .addGroup(jPanel16Layout.createSequentialGroup()
                ...
                .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel16Layout.createSequentialGroup()
                        .addGap(36, 36, 36)
                        .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(nudThresHoldLimiter1, javax.swing.GroupLayout.DEFAULT_SIZE, 67, Short.MAX_VALUE)
        ...
        jLabel22.setText("Gain Linear Input Prio");

        jLabel23.setFont(new java.awt.Font("Tahoma", 1, 12));
        jLabel23.setText("Gain Input Prio");
        ...
        jLabel26.setText("Filter Prio");

        jLabel27.setFont(new java.awt.Font("Tahoma", 0, 12));
        jLabel27.setText("Boost");
        ...
        jLabel24.setText("Filter Ch");

        jLabel25.setFont(new java.awt.Font("Tahoma", 0, 12));
        jLabel25.setText("Freq");
                    ...
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel8Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(tkbGainTone1, javax.swing.GroupLayout.DEFAULT_SIZE, 107, Short.MAX_VALUE)
        ...
        jLabel40.setText("Nombre Fuente");
        ...
        chkEnableCobraNetPrio.setText("Habilitar Prio CobraNet");
        ...
        chkManiobra5vPrio.setText("Maniobra a 5v");
        ...
        chkPuertaRuidoPrio.setText("Puerta de Ruido");
        ...
        jLabel42.setText("Umbral Puerta de Ruido");
        ...
        jLabel51.setText("Temperatura Ambiente");

        lblTempAmbiente.setText("0");

        lblMuestras.setFont(new java.awt.Font("Tahoma", 0, 12));
        lblMuestras.setText("Umbral Puerta de Ruido");
                ...
                .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel17Layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(lbltempplaca, javax.swing.GroupLayout.DEFAULT_SIZE, 55, Short.MAX_VALUE))
                        .addGroup(jPanel17Layout.createSequentialGroup()
                            .addComponent(jLabel51)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(lblTempAmbiente, javax.swing.GroupLayout.DEFAULT_SIZE, 27, Short.MAX_VALUE)))))
        );
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(lblLink, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(24, 24, 24)
                        .addComponent(lblLink, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        ...
        tmrConectado.stop();
        tmrRefresco.stop();
        try{etapa.Dispose();}catch(Exception e){}
        etapa=null;
        ...
        tmrConectado=new Timer(1000,new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    ...
                    if(etapa.GetAsinc_Connect() && etapa.GetSinc_Connect()){
                        //Parpadeo Link
                        color=!(color);
                        
                        if(color){
                           lblLink.setBackground(Color.decode("#FF4500"));
                        }else{
                           lblLink.setBackground(Color.decode("#8FBC8B"));
                        }
                        
                        if(!(Conectado)){
                            listincidencias.add(0,formato.format(new Date()) + " -> STV Conectado");
                            Conectado=true;
                        }
                        ...
                        if(Conectado){
                            listincidencias.add(0,formato.format(new Date()) + " -> STV Desconectado");
                            Conectado=false;
                        }
                    }
                }catch(Exception ex){
        ...
        tmrRefresco=new Timer(1500,new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    ...
                    if(etapa.GetInfo().num_canales<=2){
                        if(etapa.GetInfo().pot_canal==2){
                            rb2200.setSelected(true);
                        }else if(etapa.GetInfo().pot_canal==4){
                    ...
                    lblMuestras.setText(String.valueOf(bv(etapa.GetInfo().modAmp[i].NewSense)));
                    
                    chkCobraNet.setSelected(etapa.GetInfo().hay_CobraNet);
                    chkSDCard.setSelected(etapa.GetInfo().hay_SD);
                    chkPower_On.setSelected(etapa.GetInfo().Power_On);
                    
                    tkbGainOutput1.setValue(etapa.GetInfo().modAmp[i].Canal[j].GainOutput);
                    tkbGainInput1.setValue(etapa.GetInfo().modAmp[i].Canal[j].GainInput);
                    
                    nudEnableFilter1.setValue(myCByte(etapa.GetInfo().modAmp[i].Canal[j].EnableFilter));
                    nudFreqFilter1.setValue(etapa.GetInfo().modAmp[i].Canal[j].FrecFilter);
                    
                    tkbGainFilter1.setValue(etapa.GetInfo().modAmp[i].Canal[j].GainFilter);
                    
                    nudEnableLimiter1.setValue(myCByte(cbool(etapa.GetInfo().modAmp[i].Canal[j].Limitador_Modo)));
                    nudThresHoldLimiter1.setValue(etapa.GetInfo().modAmp[i].Canal[j].ThresHoldLimiter);
                    nudTCLimiter1.setValue(etapa.GetInfo().modAmp[i].Canal[j].TCLimiter);
                    nudDecayLimiter1.setValue(bv(etapa.GetInfo().modAmp[i].Canal[j].Decaylimiter));
                    nudEqInputEnable1.setValue(myCByte(etapa.GetInfo().modAmp[i].Canal[j].EnableEq));
                    nudEqInputBoost1.setValue(etapa.GetInfo().modAmp[i].Canal[j].BoostEq[l]);
                    nudEqInputFreq1.setValue(etapa.GetInfo().modAmp[i].Canal[j].FreqEq[l]);
                    nudEqInputQ_Slope1.setValue(etapa.GetInfo().modAmp[i].Canal[j].Q_SlopeEq[l]);
                    
                    tkbEqInputGain1.setValue(etapa.GetInfo().modAmp[i].Canal[j].GainEq[l]);
                    
                    nudEnableTone1.setValue(myCByte(etapa.GetInfo().modAmp[i].Canal[j].EnableTone));
                    
                    tkbGainTone1.setValue(etapa.GetInfo().modAmp[i].Canal[j].GainTone);
                    
                    nudFreqTone1.setValue(etapa.GetInfo().modAmp[i].Canal[j].FreqTone);
                    
                    tkbDC1.setValue(etapa.GetInfo().modAmp[i].Canal[j].DC);
                    tkbGainLinearInput1.setValue(etapa.GetInfo().modAmp[i].Canal[j].GainLinearInput);
                    
                    nudEnableLoudNess1.setValue(myCByte(etapa.GetInfo().modAmp[i].Canal[j].EnableLoudNess));
                    
                    chkMute.setSelected(cbool(etapa.GetInfo().modAmp[i].Canal[j].Mute));
                    
                    if(!(chkCobraNetPrio.isSelected())){
                        nudInput_channel.setValue(etapa.GetInfo().modAmp[i].Canal[j].Canal_Bundle_Cobranet);
                        nudAddr_bundle.setValue(etapa.GetInfo().modAmp[i].Canal[j].Direccion_Bundle_Cobranet);
                    }
                    
                    //Informacion de prio
                    nudFilterPrioBoost.setValue(etapa.GetInfo().modAmp[i].Prio.BoostFilterPrio);
                    nudFilterPrioFreq.setValue(etapa.GetInfo().modAmp[i].Prio.FrecFilterPrio);
                    nudFilterPrioQ_Slope.setValue(etapa.GetInfo().modAmp[i].Prio.Q_SlopeFilterPrio);
                    
                    tkbFilterPrioGain.setValue(etapa.GetInfo().modAmp[i].Prio.GainFilterPrio);
                    tkbGainLinearInputPrio.setValue(etapa.GetInfo().modAmp[i].Prio.GainLinearInputPrio);
                    tkbGainInputPrio.setValue(etapa.GetInfo().modAmp[i].Prio.GainPrio);
                    
                    if(chkCobraNetPrio.isSelected()){
                        nudInput_channel.setValue(etapa.GetInfo().modAmp[i].Prio.Canal_Bundle_Cobranet);
                        nudAddr_bundle.setValue(etapa.GetInfo().modAmp[i].Prio.Direccion_Bundle_Cobranet);
                    }
                    ...
                    chkEnableCobraNetPrio.setSelected(etapa.GetInfo().Prioridad_CobraNet_Habilitada);
                    chkPuertaRuidoPrio.setSelected(etapa.GetInfo().Prioridad_Modo_Presencia);
                    chkManiobra5vPrio.setSelected(etapa.GetInfo().Prioridad_Activacion_5V);
                    
                    nudUmbralPuertaRuido.setValue(etapa.GetInfo().Prioridad_Umbral_activacion);
                    nudDelayArranque.setValue(bv(etapa.GetInfo().DelayArranque));
                    
                    ckEnableEtherNet.setSelected(etapa.GetInfo().hay_EtherNet);
                    chkConfiguracionEntradaDigital.setSelected(etapa.GetInfo().Entrada_Digital);
                    
                    byte dBytes[]=etapa.GetN_Fuente(i, j);
                    ...
                    //Informacion variada
                    //Errores
                    chkErr12V.setSelected(cbool((byte)(bv(etapa.GetInfo().Errores[4]) & 16)));
                    chkErr230I.setSelected(cbool((byte)(bv(etapa.GetInfo().Errores[4]) & 2)));
                    chkErr230V.setSelected(cbool((byte)(bv(etapa.GetInfo().Errores[4]) & 1)));
                    chkErr3008.setSelected(cbool(etapa.GetInfo().Errores[2]));
                    chkErrCarga.setSelected(cbool((byte)(bv(etapa.GetInfo().Errores[4]) & 32)));
                    chkErrCobraNet.setSelected(cbool(etapa.GetInfo().Errores[1]));
                    chkErrComunicacion.setSelected(cbool((byte)(bv(etapa.GetInfo().Errores[4]) & 64)));
                    ChkErrFrontal.setSelected(cbool(etapa.GetInfo().Errores[7]));
                    chkErrMod1.setSelected(cbool(etapa.GetInfo().Errores[5]));
                    chkErrMod2.setSelected(cbool(etapa.GetInfo().Errores[6]));
                    chkErrRAM.setSelected(cbool(etapa.GetInfo().Errores[0]));
                    chkErrSobreTempETX.setSelected(cbool(etapa.GetInfo().Errores[8]));
                    chkErrTempETX.setSelected(cbool(etapa.GetInfo().Errores[3]));
                    chkErrVP1.setSelected(cbool((byte)(bv(etapa.GetInfo().Errores[4]) & 4)));
                    chkErrVP2.setSelected(cbool((byte)(bv(etapa.GetInfo().Errores[4]) & 8)));
                    
                    lblclave.setText(String.valueOf(etapa.GetInfo().Clave));
                    lblTemp.setText(String.valueOf(bv(etapa.GetInfo().modAmp[i].Canal[j].Temp.temp)));
                    lblTempAmbiente.setText(String.valueOf(bv(etapa.GetInfo().modAmp[i].tempAmb)));
                    lbltempplaca.setText(String.valueOf(bv(etapa.GetInfo().modAmp[i].Canal[j].Temp.tempPlaca)));
                    
                    txtLog.setText(etapa.get_STV_Log());
    ...
    private void btnConnectMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnConnectMouseClicked
        try{
            ...
            etapa=null;
            etapa=new STV();
            if(etapa.Connect(txtIP.getText()) != 1){
                JOptionPane.showMessageDialog(null,"Error de conexión","ERROR CRÍTICO",0);
            }
        }catch(Exception ex){
            System.err.println(ex);
        }
    ...
    private void tkbGainLinearInput1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_tkbGainLinearInput1StateChanged
        if(tkbGainLinearInput1.getValueIsAdjusting()==false){
            ...
            tmrRefresco.stop();
            try{etapa.set_Amp_Gain_Input_linear((byte)cv(nudChannel.getValue()),(short)cv(tkbGainLinearInput1.getValue()));}catch(Exception e){}
            tmrRefresco.start();
        }
    ...
    private void tkbGainLinearInputPrioStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_tkbGainLinearInputPrioStateChanged
        if(tkbGainLinearInputPrio.getValueIsAdjusting()==false){
            ...
            tmrRefresco.stop();
            try{etapa.set_Amp_Gain_Input_Linear_Prio((short)cv(tkbGainLinearInputPrio.getValue()));}catch(Exception e){}
            tmrRefresco.start();
        }
    ...
    private void tkbGainInput1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_tkbGainInput1StateChanged
        if(tkbGainInput1.getValueIsAdjusting()==false){
            ...
            tmrRefresco.stop();
            try{etapa.set_Amp_Gain((byte)cv(nudChannel.getValue()),true,(byte)cv(tkbGainInput1.getValue()));}catch(Exception e){}
            tmrRefresco.start();
        }
    ...
    private void tkbGainOutput1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_tkbGainOutput1StateChanged
        if(tkbGainOutput1.getValueIsAdjusting()==false){
            ...
            tmrRefresco.stop();
            try{etapa.set_Amp_Gain((byte)cv(nudChannel.getValue()),false,(byte)cv(tkbGainOutput1.getValue()));}catch(Exception e){}
            tmrRefresco.start();
        }
    ...
    private void nudEqInputBoost1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_nudEqInputBoost1StateChanged
        ...
        tmrRefresco.stop();
        try{etapa.set_Amp_Equalizer((byte)cv(nudChannel.getValue()),(byte)cv(nudEqInputBand1.getValue()),(byte)cv(nudEqInputBoost1.getValue()),cv(nudEqInputFreq1.getValue()),cv(nudEqInputQ_Slope1.getValue()),(byte)cv(tkbEqInputGain1.getValue()));}catch(Exception e){}
        tmrRefresco.start();
    ...
    private void nudEqInputEnable1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_nudEqInputEnable1StateChanged
        ...
        tmrRefresco.stop();
        try{etapa.set_Amp_Enable_Equalizer((byte)cv(nudChannel.getValue()),cbool((byte)cv(nudEqInputEnable1.getValue())));}catch(Exception e){}
        tmrRefresco.start();
    ...
    private void nudEnableLoudNess1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_nudEnableLoudNess1StateChanged
        ...
        tmrRefresco.stop();
        try{etapa.set_Amp_Enable_Loudness((byte)cv(nudChannel.getValue()),cbool((byte)cv(nudEnableLoudNess1.getValue())));}catch(Exception e){}
        tmrRefresco.start();
    ...
    private void nudEnableLimiter1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_nudEnableLimiter1StateChanged
        ...
        tmrRefresco.stop();
        try{etapa.set_Mode_Limiter_STV((byte)cv(nudEnableLimiter1.getValue()));}catch(Exception e){}
        tmrRefresco.start();
    ...
    private void nudEnableFilter1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_nudEnableFilter1StateChanged
        ...
        tmrRefresco.stop();
        try{etapa.set_Amp_Enable_Filter((byte)cv(nudChannel.getValue()),cbool((byte)cv(nudEnableFilter1.getValue())));}catch(Exception e){}
        tmrRefresco.start();
    ...
    private void nudEnableTone1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_nudEnableTone1StateChanged
        ...
        tmrRefresco.stop();
        try{etapa.set_Amp_Enable_Tone((byte)cv(nudChannel.getValue()),cbool((byte)cv(nudEnableTone1.getValue())));}catch(Exception e){}
        tmrRefresco.start();
    ...
    private void nudTCLimiter1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_nudTCLimiter1StateChanged
        ...
        tmrRefresco.stop();
        try{etapa.set_Amp_TC_Limiter((byte)cv(nudChannel.getValue()),cv(nudTCLimiter1.getValue()));}catch(Exception e){}
        tmrRefresco.start();
    ...
    private void nudDecayLimiter1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_nudDecayLimiter1StateChanged
        ...
        tmrRefresco.stop();
        try{etapa.set_Amp_Decay_Limiter((byte)cv(nudChannel.getValue()),(byte)cv(nudDecayLimiter1.getValue()));}catch(Exception e){}
        tmrRefresco.start();
    ...
    private void nudThresHoldLimiter1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_nudThresHoldLimiter1StateChanged
       ...
       tmrRefresco.stop();
       try{etapa.set_Amp_Threshold_Limiter((byte)cv(nudChannel.getValue()),(byte)cv(nudThresHoldLimiter1.getValue()));}catch(Exception e){}
       tmrRefresco.start();
    ...
    private void nudFreqFilter1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_nudFreqFilter1StateChanged
       ...
       tmrRefresco.stop();
       try{etapa.set_Amp_Filter((byte)cv(nudChannel.getValue()),cv(nudFreqFilter1.getValue()),(byte)cv(tkbGainFilter1.getValue()));}catch(Exception e){}
       tmrRefresco.start();
    ...
    private void nudFreqTone1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_nudFreqTone1StateChanged
        ...
        tmrRefresco.stop();
        try{etapa.set_Amp_Frec_Tone((byte)cv(nudChannel.getValue()),cv(nudFreqTone1.getValue()));}catch(Exception e){}
        tmrRefresco.start();
    ...
    private void tkbGainTone1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_tkbGainTone1StateChanged
        if(tkbGainTone1.getValueIsAdjusting()==false){
            ...
            tmrRefresco.stop();
            try{etapa.set_Amp_Gain_Tone((byte)cv(nudChannel.getValue()),(byte)cv(tkbGainTone1.getValue()));}catch(Exception e){}
            tmrRefresco.start();
        }
    ...
    private void tkbDC1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_tkbDC1StateChanged
        if(tkbDC1.getValueIsAdjusting()==false){
            ...
            tmrRefresco.stop();
            try{etapa.set_Amp_DC((byte)cv(nudChannel.getValue()),(short)cv(tkbDC1.getValue()));}catch(Exception e){}
            tmrRefresco.start();
        }
    ...
    private void tkbGainInputPrioStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_tkbGainInputPrioStateChanged
        if(tkbGainInputPrio.getValueIsAdjusting()==false){
            ...
            tmrRefresco.stop();
            try{etapa.set_Amp_Gain_Prio((byte)cv(tkbGainInputPrio.getValue()));}catch(Exception e){}
            tmrRefresco.start();
        }
    ...
    private void nudFilterPrioBoostStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_nudFilterPrioBoostStateChanged
        ...
        tmrRefresco.stop();
        try{etapa.set_Amp_Filter_Prio((byte)cv(nudFilterPrioBoost.getValue()),cv(nudFilterPrioFreq.getValue()),cv(nudFilterPrioQ_Slope.getValue()),(byte)cv(tkbFilterPrioGain.getValue()));}catch(Exception e){}
        tmrRefresco.start();
    ...
    private void chkMuteItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chkMuteItemStateChanged
        ...
        tmrRefresco.stop();
        try{etapa.set_Amp_Mute_Ch((byte)cv(nudChannel.getValue()),chkMute.isSelected());}catch(Exception ex){}
        tmrRefresco.start();
    ...
    private void nudAddr_bundleStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_nudAddr_bundleStateChanged
        ...
        tmrRefresco.stop();
        if(chkCobraNetPrio.isSelected()){
            try{etapa.set_Amp_CobraNet_Prio(cv(nudAddr_bundle.getValue()),(byte)cv(nudInput_channel.getValue()));}catch(Exception ex){}
        }else{
            try{etapa.set_CobraNet((byte)cv(nudChannel.getValue()),cv(nudAddr_bundle.getValue()),(byte)cv(nudInput_channel.getValue()));}catch(Exception ex){}
        }
        tmrRefresco.start();
    ...
    private void txtCobraNetNombreFuenteFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtCobraNetNombreFuenteFocusGained
        ...
        tmrRefresco.stop();
        try{etapa.set_CobraNet_Nombre_Fuente((byte)cv(nudChannel.getValue()),txtCobraNetNombreFuente.getText());}catch(Exception e){}
        tmrRefresco.start();
    ...
    private void txtCobraNetNombreZonaFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtCobraNetNombreZonaFocusGained
        ...
        tmrRefresco.stop();
        try{etapa.set_CobraNet_Nombre_Zona((byte)cv(nudChannel.getValue()),txtCobraNetNombreZona.getText());}catch(Exception e){}
        tmrRefresco.start();
    ...
    private void btnCargaDefaultMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCargaDefaultMouseClicked
        ...
        if(chkPresetsPrio.isSelected()){
            try{etapa.set_Amp_Presets((byte)'P',(byte)1);}catch(Exception ex){}
        }else{
            try{etapa.set_Amp_Presets((byte)cv(nudChannel.getValue()),(byte)1);}catch(Exception ex){}
        }
        tmrRefresco.start();
    ...
    private void btnGuardarDefaultMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnGuardarDefaultMouseClicked
        ...
        tmrRefresco.stop();
        if(chkPresetsPrio.isSelected()){
            try{etapa.set_Amp_Presets((byte)'P',(byte)2);}catch(Exception ex){}
        }else{
            try{etapa.set_Amp_Presets((byte)cv(nudChannel.getValue()),(byte)2);}catch(Exception ex){}
        }
        tmrRefresco.start();
    ...
    private void btnCargarFabricaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCargarFabricaMouseClicked
        ...
        tmrRefresco.stop();
        if(chkPresetsPrio.isSelected()){
            try{etapa.set_Amp_Presets((byte)'P',(byte)3);}catch(Exception ex){}
        }else{
            try{etapa.set_Amp_Presets((byte)cv(nudChannel.getValue()),(byte)3);}catch(Exception ex){}
        }
        tmrRefresco.start();
    ...
    private void chkPuertaRuidoPrioItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chkPuertaRuidoPrioItemStateChanged
        ...
        tmrRefresco.stop();
        try{etapa.set_Amp_Mode_Active_Prio(chkPuertaRuidoPrio.isSelected());}catch(Exception ex){}
        tmrRefresco.start();
    ...
    private void chkManiobra5vPrioItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chkManiobra5vPrioItemStateChanged
        ...
        tmrRefresco.stop();
        try{etapa.set_Amp_Level_Active_Prio(chkManiobra5vPrio.isSelected());}catch(Exception ex){}
        tmrRefresco.start();
    ...
    private void nudUmbralPuertaRuidoStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_nudUmbralPuertaRuidoStateChanged
        ...
        tmrRefresco.stop();
        try{etapa.set_Amp_ThresHold_Active_Prio((byte)cv(nudUmbralPuertaRuido.getValue()));}catch(Exception ex){}
        tmrRefresco.start();
    ...
    private void chkConfiguracionEntradaDigitalItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chkConfiguracionEntradaDigitalItemStateChanged
        ...
        tmrRefresco.stop();
        try{etapa.set_Amp_Mode_Audio_Input(chkConfiguracionEntradaDigital.isSelected());}catch(Exception ex){}
        tmrRefresco.start();
    ...
    private void rb2200ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_rb2200ItemStateChanged
        ...
        if(rb2200.isSelected()){
            tmrRefresco.stop();
            try{etapa.set_Model_STV((byte)1);}catch(Exception ex){}
            tmrRefresco.start();
            JOptionPane.showMessageDialog(null,"Reinicie STV");
        }
    ...
    private void rb2400ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_rb2400ItemStateChanged
        ...
        if(rb2400.isSelected()){
            tmrRefresco.stop();
            try{etapa.set_Model_STV((byte)2);}catch(Exception ex){}
            tmrRefresco.start();
            JOptionPane.showMessageDialog(null,"Reinicie STV");
        }
    ...
    private void rb2800ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_rb2800ItemStateChanged
        ...
        if(rb2800.isSelected()){
            tmrRefresco.stop();
            try{etapa.set_Model_STV((byte)3);}catch(Exception ex){}
            tmrRefresco.start();
            JOptionPane.showMessageDialog(null,"Reinicie STV");
        }
    ...
    private void rb4200ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_rb4200ItemStateChanged
        ...
        if(rb4200.isSelected()){
            tmrRefresco.stop();
            try{etapa.set_Model_STV((byte)4);}catch(Exception ex){}
            tmrRefresco.start();
            JOptionPane.showMessageDialog(null,"Reinicie STV");
        }
    ...
    private void rb4400ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_rb4400ItemStateChanged
        ...
        if(rb4400.isSelected()){
            tmrRefresco.stop();
            try{etapa.set_Model_STV((byte)5);}catch(Exception ex){}
            tmrRefresco.start();
            JOptionPane.showMessageDialog(null,"Reinicie STV");
        }
    ...
    private void nudChannelStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_nudChannelStateChanged
        try{
            if((byte)cv(nudChannel.getValue()) > etapa.GetInfo().num_canales){
                nudChannel.setValue(etapa.GetInfo().num_canales);
            }
        }catch(Exception ex){}
    ...
    private void chkCobraNetItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chkCobraNetItemStateChanged
        ...
        tmrRefresco.stop();
        try{etapa.set_Enable_CM2(chkCobraNet.isSelected());}catch(Exception ex){}
        tmrRefresco.start();
        JOptionPane.showMessageDialog(null,"Reinicie STV");
    ...
    private void chkSDCardItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chkSDCardItemStateChanged
        ...
        tmrRefresco.stop();
        try{etapa.set_Enable_SDCard(chkSDCard.isSelected());}catch(Exception ex){}
        tmrRefresco.start();
        JOptionPane.showMessageDialog(null,"Reinicie STV");
    ...
    private void chkPower_OnItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chkPower_OnItemStateChanged
        ...
        tmrRefresco.stop();
        try{etapa.set_Power_On(chkPower_On.isSelected());}catch(Exception ex){}
        tmrRefresco.start();
    ...
    private void chkEnableCobraNetPrioItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chkEnableCobraNetPrioItemStateChanged
        ...
        tmrRefresco.stop();
        try{etapa.set_Amp_Mode_Enable_CobraNet_Prio(chkEnableCobraNetPrio.isSelected());}catch(Exception ex){}
        tmrRefresco.start();
    ...
    private void btnResetMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnResetMouseClicked
        ...
        tmrRefresco.stop();
        try{etapa.set_Software_Reset();}catch(Exception ex){}
        tmrRefresco.start();
    ...
    private void ckEnableEtherNetItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_ckEnableEtherNetItemStateChanged
        ...
        tmrRefresco.stop();
        try{etapa.set_Enable_EtherNet(ckEnableEtherNet.isSelected());}catch(Exception ex){}
        tmrRefresco.start();
    ...
    private void btBorrarLogoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btBorrarLogoMouseClicked
        ...
        tmrRefresco.stop();
        try{etapa.set_Frontal_Borrar_Logo();}catch(Exception ex){}
        tmrRefresco.start();
    ...
    private void nudDelayArranqueStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_nudDelayArranqueStateChanged
        ...
        tmrRefresco.stop();
        try{etapa.set_Delay_Arranque_Fuente((byte)cv(nudDelayArranque.getValue()));}catch(Exception ex){}
        tmrRefresco.start();
