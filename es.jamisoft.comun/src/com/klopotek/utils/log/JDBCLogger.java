    ...
    public void setLogType(String _name, int _logtype, Object _value) throws Exception {
        ...
        for (int i = 0; i < num; i++) {
            ...
            if (logcol.name.equals(_name)) {
                ...
                // Column will be provided by JDBCIDHandler::getID()
                    ...
                    try {
                        ...
                        try {
                            ...
                            throw new Exception("JDBCLogger::setLogType(), Cannot cast value of class "
                ...
                // Columns which are not nullable, but should be not filled, must be explicit assigned
                // with LogType.EMPTY,
    ...
    public boolean ready() {
        ...
        for (int i = 0; i < num; i++) {
            ...
            if ((logcol.logtype == LogType.ID) && (logcol.idhandler == null)) {
                ...
                return false;
            } else if (logcol.logtype == LogType.MSG) {
                msgcol_defined = true;
            }
        }
...
class LogType {
    ...
    public static boolean isLogType(int _lt) {
        if ((_lt == MSG) || (_lt == STATIC) || (_lt == ID) || (_lt == TIMESTAMP) || (_lt == EMPTY)) {
            return true;
        }
    ...
    public static int parseLogType(String _lt) {
        ...
        if (_lt.equals("STATIC")) {
            return STATIC;
        }

        if (_lt.equals("TIMESTAMP")) {
            return TIMESTAMP;
        }
