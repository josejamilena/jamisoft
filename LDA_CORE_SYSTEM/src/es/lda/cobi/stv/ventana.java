...
public class ventana extends javax.swing.JFrame {
    private static final ResourceBundle config = ResourceBundle.getBundle("es.lda.cobi.stv.config");
    ...
    public ventana() {
        ...
        jPanel11.setBorder(new TitledBorder(new LineBorder(Color.cyan, 0), "Modelo STV"));
        jPanel12.setBorder(new TitledBorder(new LineBorder(Color.cyan, 0), "Acciones"));
        jPanel13.setBorder(new TitledBorder(new LineBorder(Color.red, 0), "Errores"));
        jPanel14.setBorder(new TitledBorder(new LineBorder(Color.yellow, 0), "Fuente de Alimentacion"));
        jPanel15.setBorder(new TitledBorder(new LineBorder(Color.red, 0), "Log"));
        jPanel16.setBorder(new TitledBorder(new LineBorder(Color.red, 0), "Limiter Ch"));
        jPanel17.setBorder(new TitledBorder(new LineBorder(Color.yellow, 0), "Infor"));
        this.pack();
        this.setResizable(false);
    }

    public ventana(String lNF) {
        try {
            if (!lNF.isEmpty()) {
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(tkbEqInputGain1, javax.swing.GroupLayout.DEFAULT_SIZE, 349, Short.MAX_VALUE)
                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel17Layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(lbltempplaca, javax.swing.GroupLayout.DEFAULT_SIZE, 63, Short.MAX_VALUE))
                        .addGroup(jPanel17Layout.createSequentialGroup()
                            .addComponent(jLabel51)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(lblTempAmbiente, javax.swing.GroupLayout.DEFAULT_SIZE, 35, Short.MAX_VALUE)))))
        );
        ...
        tmrRefresco = new Timer(1500, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    byte dBytes[] = etapa.getNSource(i, j);
                    ...
                    txtLog.setText(etapa.getSTVLog());
    ...
    private void nudEqInputBoost1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_nudEqInputBoost1StateChanged
        ...
        tmrRefresco.stop();
        try {
            etapa.setAmpEqualizer((byte) cv(nudChannel.getValue()), (byte) cv(nudEqInputBand1.getValue()), (byte) cv(nudEqInputBoost1.getValue()), cv(nudEqInputFreq1.getValue()), cv(nudEqInputQ_Slope1.getValue()), (byte) cv(tkbEqInputGain1.getValue()));
        } catch (Exception e) {
        }
        tmrRefresco.start();
    ...
    private void txtCobraNetNombreFuenteFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtCobraNetNombreFuenteFocusGained
        ...
        tmrRefresco.stop();
        try {
            etapa.setCobraNetSourceName((byte) cv(nudChannel.getValue()), txtCobraNetNombreFuente.getText());
        } catch (Exception e) {
        }
        tmrRefresco.start();
    ...
    private void nudDelayArranqueStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_nudDelayArranqueStateChanged
        ...
        tmrRefresco.stop();
        try {
            etapa.setDelayBootSource((byte) cv(nudDelayArranque.getValue()));
        } catch (Exception ex) {
        }
        tmrRefresco.start();
    ...
    public static void main(String args[]) {
        System.out.println("Locale" + " (" + Locale.getDefault().getDisplayLanguage() + ", " + Locale.getDefault().getDisplayCountry() + ").");
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                ventana w = new ventana(config.getString("LOOK_AND_FEEL"));
                w.setVisible(true);
            }
        });
    }
